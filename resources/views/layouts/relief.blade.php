        ...
        <div class="mx-auto grid overflow-hidden grid-cols-4 grid-rows-1 gap-10 lg:w-10/12 sm:w-auto">
            <div class="row-end-auto col-start-1 grid grid-cols-1 gap-5">
                <div class="h-fit w-10/12 mx-auto grid grid-cols-1 gap-5">
                    <a href="#"
                        class="{{ $relief == 'demand-of-resources' ? 'active-setting-button' : 'is-setting-button' }}">
                        <x-icon name="cube" class="w-4.5 h-4.5" />
                        <span>Resource Demand</span>
                    </a>
                    <a href="#" class="{{ $relief == 'shelter' ? 'active-setting-button' : 'is-setting-button' }}">
                    ...
                    <div class="mt-5">
                        ...
                        <div class="grid grid-cols-1 gap-1">
                            <a href="{{ route('setting.organization') }}"
                                class="{{ $relief == 'organizations' ? 'active-setting-button' : 'is-setting-button' }}">
                                <x-icon name="cube-transparent" class="w-4.5 h-4.5" />
                                <span>Equipments</span>
                            </a>
                            <a href="{{ route('setting.user') }}"
                                class="{{ $relief == 'users' ? 'active-setting-button' : 'is-setting-button' }}">
