<x-card>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-1 gap-4 soft-scrollbar">
        <x-input class="col-span-2" label="Type" placeholder="Enter type name of disaster" wire:model="type" />
    </div>
    ...
    <x-slot name="footer">
        <div class="flex justify-end gap-x-4">
            ...
            <div class="flex justify-between gap-x-2">
                ...
                @elseif ($actionType == 'edit')
                    <x-button positive label="Save Changes" spinner="saveDisasterType" wire:click="saveDisasterType" />
                @endif
            </div>
        </div>
    </x-slot>
