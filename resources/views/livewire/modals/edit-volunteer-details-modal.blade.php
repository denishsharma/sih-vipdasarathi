<x-card>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 soft-scrollbar">
        ...
        <x-inputs.maskable mask="#### #### ####" label="Aadhar Card Number" placeholder="Enter Aadhar card number" wire:model="aadhar" />
    ...
    <x-slot name="footer">
        <div class="flex justify-end gap-x-4">
            <div class="flex justify-between gap-x-2">
                ...
                @if ($actionType == 'add')
                    <x-button positive spinner="addVolunteerProfile" label="Add Volunteer" wire:click="addVolunteerProfile" />
                @elseif ($actionType == 'edit')
                    <x-button positive label="Save Changes" spinner="saveVolunteerProfile" wire:click="saveVolunteerProfile" />
                @endif
            </div>
        </div>
    </x-slot>
