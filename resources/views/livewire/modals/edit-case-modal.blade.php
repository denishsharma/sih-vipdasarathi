<x-card>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 soft-scrollbar">
        <div class="col-span-1 sm:col-span-2">
            <x-input label="Title" placeholder="Enter title for the case" wire:model="title" />
        </div>
        <div class="col-span-1 sm:col-span-2">
        ...
        <div class="col-span-1 sm:col-span-2 mt-2">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <x-select
                    ...
                    :async-data="route('api.country.states')"
                    option-label="name"
                    option-value="id"
                    wire:model="state" />
            </div>
        ...
        <div class="col-span-1 sm:col-span-2 mt-2">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <x-select
                    ...
                    :async-data="route('api.disaster.types.all')"
                    option-label="name"
                    option-value="id"
                ...
                <x-select
                    ...
                    :options="[
                        ...
                        ['name' => 'SOP 2018', 'value' => '4']
                    ]"
                    option-label="name"
                    option-value="value"
                    wire:model="selectedSop" />

                <x-select label="Priority" Placeholder="Select Priority" :options="['Low', 'Medium', 'High', 'Urgent']" wire:model="priority" />
    ...
    <x-slot name="footer">
        <div class="flex justify-end gap-x-4">
            ...
            <div class="flex justify-between gap-x-2">
                ...
                @elseif ($actionType == 'edit')
                    <x-button positive label="Save Changes" spinner="saveCaseDetails" wire:click="saveCaseDetails" />
                @endif
            </div>
        </div>
    </x-slot>
