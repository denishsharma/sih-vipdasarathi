            ...
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div class="hidden sm:block sm:ml-6">
                    <div class="flex space-x-2">
                        ...
                        <a href="#" class="bg-primary-700 text-white px-3 py-2 rounded-md text-sm font-medium" aria-current="page">Dashboard</a>

                        <a href="#" class="text-gray-700 hover:bg-gray-200 px-3 py-2 rounded-md text-sm">Team</a>

                        <a href="#" class="text-gray-700 hover:bg-gray-200 px-3 py-2 rounded-md text-sm">Projects</a>

                        <a href="#" class="text-gray-700 hover:bg-gray-200 px-3 py-2 rounded-md text-sm">Calendar</a>
                    </div>
                </div>
            </div>
