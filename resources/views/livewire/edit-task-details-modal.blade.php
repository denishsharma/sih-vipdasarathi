<x-modal.card title="Edit Task Details" wire:model.defer="editTaskDetails">
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 soft-scrollbar">
        <div class="col-span-1 sm:col-span-2">
            <x-input label="Subject" placeholder="Enter subject of the task in short" wire:model.defer="name" />
        ...
        <div class="col-span-1 sm:col-span-2">
            <x-textarea label="Description" placeholder="Describe your task in detail..." wire:model.defer="description" />
        </div>

        <div class="col-span-1 sm:col-span-2 mt-2">
            <h4 class="block text-md font-semibold text-gray-700 mb-2.2">Assign to Teams</h4>
            <div class="flex justify-between gap-4 mb-2.5">
                <x-select
                    ...
                    class="flex-auto"
                />
                <x-button default spinner label="Assign Team" class="flex-none"/>
            </div>
            <div class="">
                <ul role="list" class="border border-gray-200 rounded-md divide-y divide-gray-200">
                    <li class="pl-3 pr-4 py-3 flex items-center justify-between text-sm">
                        <div class="w-0 flex-1 flex items-center">
                            ...
                            <span class="ml-2 flex-1 w-0 truncate">Team 1</span>
                        </div>
                    ...
                    <li class="pl-3 pr-4 py-3 flex items-center justify-between text-sm">
                        <div class="w-0 flex-1 flex items-center">
                            <x-icon name="user-group" class="w-5 h-5 flex-shrink-0 text-gray-400" />
                            <span class="ml-2 flex-1 w-0 truncate">Team </span>
                        </div>
                        <div class="ml-4 flex-shrink-0">
                            <a href="#" class="font-medium text-red-600 hover:text-red-300-500">Remove</a>
                        </div>
