                            ...
                            <tr
                                ...
                                <td scope="row" class="py-2 px-6 text-gray-900 whitespace-nowrap dark:text-white">
                                    <div class="grid grid-rows-2 grid-cols-1 gap-0.4">
                                        <h4 class="text-sm font-medium text-gray-700">Assam Not enough supplies</h4>
                                    </div>
                                </td>
                                <td class="py-4 px-6">
                                    <span
                                        class="bg-red-100 text-red-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-red-200 dark:text-red-800">Supply medical supplies</span>
                                </td>
                                <td scope="row" class="py-2 px-6 text-gray-900 whitespace-nowrap dark:text-white">
                                    <div class="grid grid-rows-2 grid-cols-1 gap-0.4">
                                        <span
                                        class="bg-red-100 text-red-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-red-200 dark:text-red-800">Resource Ticket</span>
                                ...
                                <td class="py-4 px-6">
                                    <span
                                        class="bg-orange-100 text-orange-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-orange-200 dark:text-orange-800">xyz</span>
                                </td>
