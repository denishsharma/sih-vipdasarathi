@extends('pages.cases.view.master', ['activeSection' => 'volunteers'])
    ...
    <nav class="flex" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-2">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    <x-icon name="chevron-right" class="w-3 h-3 text-gray-400" />
                    <span class="ml-1 text-sm font-medium text-gray-700 md:ml-2 dark:text-gray-400">Volunteers</span>
                </div>
            </li>
        </ol>
    </nav>
            ...
            <tbody>
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="py-4 px-6 text-right flex items-center justify-end gap-3">
                        ...
                        <a href="{{ route('volunteer.view.overview', ['signature' => '666']) }}"
