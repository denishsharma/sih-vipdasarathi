            ...
            <div class="row-end-auto col-start-1 grid grid-cols-1 gap-5">
                <div class="h-fit w-10/12 mx-auto">
                    <div class="grid grid-cols-1 gap-1">
                        <a href="{{ route('volunteer.profiles') }}" class="active-setting-button">
                            <x-icon name="identification" class="w-4.5 h-4.5" />
                            <span>All Cases</span>
                        </a>
                        <a href="{{ route('volunteer.tokens') }}" class="is-setting-button">
                            <x-icon name="database" class="w-4.5 h-4.5" />
                            <span>Active Cases</span>
                        </a>
                        <a href="is-setting-button" class="is-setting-button">
