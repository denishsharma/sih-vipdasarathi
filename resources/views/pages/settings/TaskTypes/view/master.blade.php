            ...
            <div class="row-end-auto col-start-1 grid grid-cols-1 gap-5">
                <div class="h-fit w-10/12 mx-auto">
                    <div class="grid grid-cols-1 gap-1">
                        <a href="{{ route('setting.task-types.view.overview', ['signature' => '123']) }}" class="{{ ($activeSection=='overview') ? 'active-setting-button' : 'is-setting-button' }}">
                            <x-icon name="identification" class="w-4.5 h-4.5" />
                            <span>Overview</span>
                        </a>
                        <a href="{{ route('setting.task-types.view.no-of-task', ['signature' => '123']) }}" class="{{ ($activeSection=='overview') ? 'active-setting-button' : 'is-setting-button' }}">
                            <x-icon name="identification" class="w-4.5 h-4.5" />
                            <span>No of Task</span>
                        </a>
                    </div>
                </div>
            </div>
